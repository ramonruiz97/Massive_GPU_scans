...
r_mumin, r_mumax = 2000,10000#-10000, -1000
...
#Not used: Calculated by SU(2) symetry -> Used as placeholder for saving them in the tuple
...
r_du13RRmin, r_du13RRmax = -0.4, 0.4#:
...
i_du13RRmin, i_du13RRmax = -0.4,0.4#:
