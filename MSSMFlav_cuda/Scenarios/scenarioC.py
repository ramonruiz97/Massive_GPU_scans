...
msqmin, msqmax = 4000, 10000
Mgmin, Mgmax = 4000, 15000
tanbmin, tanbmax = 10.,50.#10.,50.
MAmin , MAmax = 5000.,20000.

r_mumin, r_mumax = 5000,20000#-10000, -1000
r_M1min, r_M1max = 5000., 5000. ## universality level. M1 = r_M1 *M3 * alpha1/alpha3
r_M2min, r_M2max = 3000., 3000. ## universality level. M2 = r_M2 *M3 * alpha2/alpha3
...
rhv = 0.
msnumin, msnumax = 1000., 10000. #Not needed
